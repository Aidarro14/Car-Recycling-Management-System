...
using System.ComponentModel.DataAnnotations; // Убедитесь, что это using есть

namespace CarRecyclingWeb.Models // Или ваш namespace
{
    public static class EnumExtensions
    {
            ...
            where TEnum : Enum
        {
            ...
            // Если дошли сюда, значит, строка не соответствует ни одному члену enum
